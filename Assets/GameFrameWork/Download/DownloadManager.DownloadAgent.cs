        ...
        private sealed class DownloadAgent : ITaskAgent<DownloadTask>, IDisposable
        {
            ...
            public void Update(float elapseSeconds, float realElapseSeconds)
            {
                if(m_Task.Status == DownloadTaskStatus.Doing)
                {
                    ...
                    {
                        OnDownloadAgentHelperError(this, new DownloadAgentHelperErroeEventArgs("Timeout"));
                    }
                }
            }
            ...
            public StartTaskStatus Start(DownloadTask task)
            {
                ...
                {
                    OnDownloadAgentHelperError(this, new DownloadAgentHelperErroeEventArgs(exception.Message));
            ...
            private void OnDownloadAgentHelperError(object sender, DownloadAgentHelperErroeEventArgs e)
            {
                m_Helper.Reset();
                if(m_FileStream != null)
                {
