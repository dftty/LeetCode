...
namespace GameFramework.Resources
{
    internal sealed partial class ResourceManager
    {
        ...
        private sealed partial class ResourceChecker
        {
            ...
            {
                if(!m_VersionListReady || !m_ReadWriteListReady || !m_ReadWriteListReady)
                {
                    return ;
                }
                ...
                foreach(KeyValuePair<ResourceName, CheckInfo> checkInfo in m_CheckInfos)
                {
                    ...
                    }else if(ci.Status == CheckInfo.CheckStatus.NeedUpdate)
                    {
                        ...
                        updateTotalLength += ci.ZipLength;
                ...
                try
                {
                    ...
                    using (BinaryReader binaryReader = new BinaryReader(memoryStream, Encoding.UTF8))
                    {
                        ...
                        if(listVersion == 0)
                        {
                            ...
                            m_ResourceManager.m_ResourceInfos = new Dictionary<ResourceName, ResourceInfo>(resourceCount);
