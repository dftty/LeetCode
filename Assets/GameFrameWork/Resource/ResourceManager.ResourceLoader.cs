        ...
        private sealed partial class ResourceLoader
        {
            ...
            public void LoadAsset(string assetName, Type assetType, int priority, LoadAssetCallbacks loadAssetCallbacks, object userData)
            {
                ...
                if (!CheckAsset(assetName, out resourceInfo, out dependencyAssetNames))
                {
                    ...
                    {
                        loadAssetCallbacks.LoadAssetFailureCallback(assetName, LoadResourcesStatus.NotReady, errorMessage, userData);
                        return;
                    }
                ...
                foreach (string dependencyAssetName in dependencyAssetNames)
                {
                    if (!LoadDependencyAsset(dependencyAssetName, priority, mainTask, userData))
                    {
                        ...
                        if (loadAssetCallbacks.LoadAssetFailureCallback != null)
                        {
                            loadAssetCallbacks.LoadAssetFailureCallback(assetName, LoadResourcesStatus.DependencyError, errorMessage, userData);
                            return;
                        }
            ...
            public void LoadScene(string sceneAssetName, int priority, LoadSceneCallbacks loadSceneCallbacks, object userData)
            {
                ...
                if(!CheckAsset(sceneAssetName, out resourceInfo, out dependencyAssetNames))
                {
                    ...
                    {
                        loadSceneCallbacks.LoadSceneFailureCallback(sceneAssetName, LoadResourcesStatus.NotReady, errorMessage, userData);
                        return ;
                    }
                ...
                foreach(string dependencyAssetName in dependencyAssetNames)
                {
                    if(!LoadDependencyAsset(dependencyAssetName, priority, mainTask, userData))
                    {
                        ...
                        if (loadSceneCallbacks.LoadSceneFailureCallback != null)
                        {
                            loadSceneCallbacks.LoadSceneFailureCallback(sceneAssetName, LoadResourcesStatus.DependencyError, errorMessage, userData);
                            return;
                        }
