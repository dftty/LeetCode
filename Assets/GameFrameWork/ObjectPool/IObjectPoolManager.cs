...
namespace GameFramework.ObjectPool
{
    ...
    public interface IObjectPoolManager
    {
        ...
        /// <returns></returns>
        ObjectPoolBase[] GetObjectPools(Predicate<ObjectPoolBase> contidion);
        ...
        void GetObjectPools(Predicate<ObjectPoolBase> condition, List<ObjectPoolBase> result);
        ...
        /// 获取所有对象池
        /// </summary>
        /// <param name="sort">是否根据优先级排序</param>
        /// <returns></returns>
